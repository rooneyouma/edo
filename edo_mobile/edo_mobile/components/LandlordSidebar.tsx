...
export default function LandlordSidebar({
  ...
  const menuItems: MenuItem[] = [
    { label: "Dashboard", icon: "grid", route: "/landlord/page" },
    {
      label: "Properties",
      icon: "business",
      route: "/landlord/properties/page",
    }, // Changed icon from "home" to "business"
    { label: "Tenants", icon: "people", route: "/landlord/tenants/page" },
    {
      label: "Maintenance",
      icon: "construct",
      route: "/landlord/maintenance/page",
    },
    { label: "Payments", icon: "cash", route: "/landlord/payments/page" },
    {
      label: "Notices",
      icon: "document-text",
