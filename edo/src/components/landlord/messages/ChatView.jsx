            ...
            return (
              ...
              >
                ...
                {!isCurrentUserMessage && (
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-gray-100 flex items-center justify-center flex-shrink-0 mr-2 sm:mr-3">
                ...
                {isCurrentUserMessage && (
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0 order-2 ml-2 sm:ml-3">
