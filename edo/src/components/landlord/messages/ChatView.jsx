...
const ChatView = ({
  ...
  return (
    <div className="h-full flex flex-col bg-white dark:bg-slate-800 max-h-[60vh] sm:max-h-[80vh] w-full max-w-full" style={{ minHeight: 0 }}>
      ...
      {/* Messages */}
      <div className="flex-1 min-h-0 overflow-y-auto p-4 space-y-4" style={{ maxHeight: 'none' }}>
        {selectedChat.messages.map((message) => (
          ...
          >
            ...
            <div className={`max-w-xs px-4 py-2 rounded-lg text-sm ${message.sender === 'landlord' ? 'bg-teal-500 text-white' : 'bg-slate-200 dark:bg-slate-700 text-slate-900 dark:text-slate-100'}`}>
