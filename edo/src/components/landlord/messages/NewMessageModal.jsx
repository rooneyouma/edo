      ...
      >
        <div className="p-6 flex-shrink-0">
          <div className="flex justify-between items-start">
            <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">Send New Message</h3>
            <button
              onClick={onClose}
        ...
        <form ref={formRef} id="new-message-form" onSubmit={handleSubmit} className="px-6 pb-6 flex-grow overflow-y-auto">
          <div className="space-y-4">
            <div>
              ...
              <div className="mt-1 relative" ref={dropdownRef}>
                <input
                  ...
                  className="block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-violet-500 focus:ring-violet-500 sm:text-sm dark:bg-gray-700 dark:text-gray-100"
                  placeholder="Search by tenant name, property, or unit..."
                  required
                />
                {showDropdown && tenantSearchQuery && filteredTenants.length > 0 && (
                  <div className="absolute z-50 mt-1 w-full bg-white dark:bg-gray-800 shadow-lg rounded-md border border-gray-200 dark:border-gray-700 max-h-60 overflow-y-auto">
                    {filteredTenants.map((tenant) => (
                      ...
                      >
                        <div className="text-sm text-gray-900 dark:text-gray-100">{tenant.name}</div>
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-violet-500 focus:ring-violet-500 sm:text-sm dark:bg-gray-700 dark:text-gray-100"
                readOnly
              />
            </div>
