...
export default function ThemeToggle() {
  ...
  // Set initial theme and mount status
  useEffect(() => {
    setMounted(true);
  ...
  if (!mounted) {
    return (
      <button
        type="button"
        className="flex items-center justify-center cursor-pointer w-8 h-8 rounded-full transition-colors duration-200"
  ...
  return (
    <button
      type="button"
      onClick={toggleTheme}
      className="flex items-center justify-center cursor-pointer w-8 h-8 hover:bg-gray-100 lg:hover:bg-gray-200 dark:hover:bg-gray-700/50 dark:lg:hover:bg-gray-800 rounded-full transition-colors duration-200"
