    ...
    <header
      className={`sticky top-0 before:absolute before:inset-0 before:backdrop-blur-md max-lg:before:bg-white/90 before:-z-10 z-30 ${
        variant === "v2" || variant === "v3"
          ...
          : "max-lg:shadow-xs lg:before:bg-gray-100"
      } ${variant === "v2" ? "" : ""} ${variant === "v3" ? "" : ""}`}
    >
      <div className="px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              type="button"
              className="p-1 rounded-full text-slate-500 hover:text-slate-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500"
